...
module.exports = function(videoId) {
  ...
  return new promise(function(resolve, reject) {
    ...
    youtube_dl = spawn('youtube-dl', ['--extract-audio', '--audio-format', 'mp3', '-R', '100', '-o', inputPath + '/' + videoId + '.%(ext)s', "http://www.youtube.com/watch?v=" + videoId]);
    ...
    youtube_dl.on('exit', function() {
      ...
      ffmpeg(inputPath + '/' + videoId + '.mp3')
        .save(inputPath + '/' + videoId + '.flac')
